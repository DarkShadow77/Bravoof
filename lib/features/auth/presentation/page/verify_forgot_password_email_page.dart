...
class VerifyForgotPasswordEmailPage extends StatefulWidget {
  final String email;

  VerifyForgotPasswordEmailPage({required this.email, super.key});

  @override
  State<VerifyForgotPasswordEmailPage> createState() =>
      _VerifyForgotPasswordEmailPageState();
}

class _VerifyForgotPasswordEmailPageState
    extends State<VerifyForgotPasswordEmailPage>
    with UIToolMixin {
  ...
  Future<void> resendOtp() async {
    if (_resendCode) {
      ...
      context.read<AuthBloc>().add(ResendResetOtpEvent(email: widget.email));
    }
  }
  ...
  void _successAuthState(
    BuildContext context,
    AuthTextSuccessState state,
  ) async {
    if (state.type == AuthType.verifyForgotPasswordOtp) {
  ...
  void _failedAuthState(BuildContext context, AuthFailureState state) {
    ...
    if (state.type == AuthType.resendResetOtp ||
        state.type == AuthType.verifyForgotPasswordOtp) {
