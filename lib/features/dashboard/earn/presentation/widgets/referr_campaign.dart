...
class _ReferCampaignState extends State<ReferCampaign> {
  ...
  void initState() {
    ...
    if (widget.campaign != null) {
      ...
      campaignList = widget.campaignList;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: widget.showMargin ? EdgeInsets.symmetric(horizontal: 16.w) : null,
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) => BlocProvider<CampaignBloc>(
                              ...
                              child: ReferralContestScreen(campaign: campaign),
                            ),
                          ),
                        );
                      },
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.group, color: textColor, size: 15.sp),
                              RichText(
                                text: TextSpan(
                                  text: '+12',
