...
class _ReclaimMissionPopupState extends State<ReclaimMissionPopup> with UIToolMixin{
                            ...
                            Flexible(
                              child: Column(
                                children: [
                                  ...
                                  _buildStep(
                                    number: "2",
                                    title: "Connect your google calendar to Reclaim or Create your first task",
                                    icon: Image.asset("assets/images/note.png", height: 40),
                                  ),
