...
import '../../../mission/presentation/widget/featured_event_dialog.dart';

class FeaturedBrandCard extends StatefulWidget {
  const FeaturedBrandCard({super.key, required this.textColor});

  final Color textColor;

  @override
  State<FeaturedBrandCard> createState() => _FeaturedBrandCardState();
}
...
class _FeaturedBrandCardState extends State<FeaturedBrandCard>
  ...
  void initState() {
    super.initState();
    final featuredBloc = BlocProvider.of<BrandIndividualBloc>(context);
    featuredMissions = featuredBloc.state.featuredMissions;
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<BrandIndividualBloc, BrandIndividualState>(
      builder: (context, state) {
        ...
        } else if (featuredMissions.isEmpty) {
          return SizedBox(
            height: 80.h,
            child: Center(
              child: RichText(
                text: TextSpan(
                  text: "No Featured Missions Yet",
