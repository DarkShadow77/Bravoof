class SkillUpTaskResponse {
  ...
  SkillUpTaskResponse({this.task});
  SkillUpTaskResponse.fromJson(Map<String, dynamic> json) {
    task = List<SkillUpTask>.from(
      json['task'].map((e) => SkillUpTask.fromJson(e)),
    );
  }
}
...
class SkillUpTask {
  ...
  SkillUpTask.fromJson(Map<String, dynamic> json) {
    ...
    if (json['second_mission']['second_mission'] != null) {
      secondMission = SkillUp.fromJson(
        json['second_mission']['second_mission'],
      );
    }
...
class SkillUp {
  SkillUp(this.subject, this.contentOne, this.contentTwo, this.contentThird);
  String? subject;
  Task? contentOne;
  Task? contentTwo;
  Task? contentThird;
