...
class Quiz {
  Quiz({this.question, this.correctAnswer, this.id, this.quizAnswers});
  String? question;
  ...
  Quiz.fromJson(Map<String, dynamic> json) {
    ...
    if (json['quiz_answers'] != null) {
      quizAnswers = List<QuizAnswers>.from(
        json['quiz_answers'].map((e) => QuizAnswers.fromJson(e)),
      );
    }
  }
}
