...
class _AskingDialogState extends State<SponsoredEventDialog> with UIToolMixin {
  ...
  bool get isVideo => widget.sponsoredMission.submissionType == "video";
  bool get isPhoto => widget.sponsoredMission.submissionType == 'photo';
                    ...
                    children: [
                      ...
                      ConstrainedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount:
                              widget.sponsoredMission.instructions.length,
      ...
      child: isLast
          ? Column(
              ...
              children: [
                ...
                if (widget.sponsoredMission.submissionType == "text")
                  AppTextFeild(
