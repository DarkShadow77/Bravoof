...
Future<dynamic> communityEventDialog({
  required CommunityMission communityMission,
}) async {
  return Get.dialog(
    name: "community_event_dialog",
...
class CommunityEventDialog extends StatefulWidget {
  const CommunityEventDialog({super.key, required this.communityMission});

  final CommunityMission communityMission;

  @override
  State<CommunityEventDialog> createState() => _AskingDialogState();
}
...
class _AskingDialogState extends State<CommunityEventDialog> with UIToolMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<CommunityMissionBloc, CommunityMissionState>(
        listener: (context, state) {
          if (state is CommunityMissionLoading &&
                        ...
                        children: [
                          ...
                          Expanded(
                            child: RichText(
                              ...
                              text: TextSpan(
                                text: widget.communityMission.instructionTitle,
