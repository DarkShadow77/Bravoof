...
import 'auth_link_repository.dart';

class AuthLinkRepositoryImpl extends AuthLinkRepository {
  ...
  Future<Either<String, String>> addPassword({required String password}) async {
  ...
  Future<Either<String, String>> unlinkProvider({
